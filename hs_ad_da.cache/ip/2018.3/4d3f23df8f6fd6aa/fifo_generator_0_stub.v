...
/* synthesis syn_black_box black_box_pad_pin="wr_clk,rd_clk,din[7:0],wr_en,rd_en,dout[7:0],full,almost_full,empty,almost_empty,rd_data_count[6:0],wr_data_count[6:0]" */;
  input wr_clk;
  input rd_clk;
  input [7:0]din;
  input wr_en;
